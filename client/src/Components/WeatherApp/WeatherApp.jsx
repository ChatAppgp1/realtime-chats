...
export const WeatherApp = () => {
    let api_key="e3b96db659a2bff3b43d4566a5c07e5a";
    ...
    return (
        ...
        <div className='container'>
            <div className="top-bar">
              ...
              <div className= "search-icon" id="search-button" onClick={()=>{search()}}>
            ...
            <div className="weather-description">Broken Clouds</div>
